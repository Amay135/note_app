...
- **Manajemen Catatan (CRUD):** Tambah, lihat, edit, dan hapus catatan dengan mudah.
- **Penyematan Catatan (Pin):** Menyematkan catatan penting agar selalu berada di posisi paling atas.
- **Kategori & Pengingat:** Mengelompokkan catatan berdasarkan kategori (Kuliah, Kerja, Keuangan, dll) dan mengatur tanggal pengingat (*deadline*).
...
1. **Clone Repositori ini**
   ```bash
   git clone https://github.com/Amay135/note_app.git
